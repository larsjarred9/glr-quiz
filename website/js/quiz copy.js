(function () //creates the questions and the entire quiz
{
  ...
  var allQuestions = [{ // Vul hier je vragen in (0= , 1=2, 2=3, 3=4, 4=5, enzovoorts)
    ...
    options: ["Central Style Sheet", "Cascading Style Sheet"],
    answer: 1
  }, {
    question: "Wat is de meest gebruikte webserver",
    options: ["Nginx", "Litespeed", "Apache"],
    answer: 2
  }];
